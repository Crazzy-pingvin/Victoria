...
ent-ClothingHeadHatBeretQM = cargo technician beret
    .desc = A beret with the cargo's insignia emblazoned on it. For cargo technicians that are more inclined towards style.
