...
hidden-desc-bruteforcer-hound = [color=#800000]Хакерский инструмент, гораздо более грубый чем ЕМАГ. Вызывает экстренное болтирование дверей.[/color]
hidden-desc-bruteforcer-syndicate = [color=#e31735]Устройство, мгновенно болтирующее двери. Принадлежит Гончим, так что ,скорее всего, вы влипли.[/color]
hidden-desc-bruteforcer-research = [color=##A46106]Устройство, использующее внутренние системы защиты шлюзов от взлома "грубой силой" для их болтирования. Не выглядит как что-то кустарное.[/color]

hidden-desc-houndknife-hound = [color=#800000] Аномально острый нож. Кажется, будто лезвие само стремится в уязвимые части тел, огибая броню. Ты видишь своё отражение на лезвии...[/color]
hidden-desc-houndknife-syndicate = [color=#e31735]До жути острый нож, замаскированный под обычный кухонный.[/color]
hidden-desc-houndknife-chef = [color=##A46106]Кажется, этот кухонный нож заточен куда больше необходимого, а лезвие будто тянется к вашей руке. Может с ним что-то не так?[/color]

hidden-desc-pseudo-ointment-medical = [color=#52B4E9]На ощупь эта мазь жжётся! Это замаскированная агрессивная щёлочь и никакое не лекарство![/color]
hidden-desc-pseudo-ointment-hound = [color=#800000]Гидрид натрия, замаскированный под противоожоговую мазь.[/color]

hidden-desc-pseudo-brutepack-medical = [color=#52B4E9]Внутри пластырей и компрессов скрыта...НОЖДАЧКА!!![/color]
hidden-desc-pseudo-brutepack-hound = [color=#800000]Образивная поверхность, замаскированная под различные мед. припасы. Эффект на коже подобен тёрке.[/color]

hidden-desc-pseudo-gauze-medical = [color=#52B4E9]При изгибании пластыря под нужным углом из него выходят небольшие иглы![/color]
hidden-desc-pseudo-gauze-hound = [color=#800000]Внутри бинта скрыты крошечные лезвия и отнюдь не для акупунктуры.[/color]

hidden-desc-ProtoKinetic-hound = [color=#800000]Протокинетик, разогнанный до пределов своих возможностей.[/color]
hidden-desc-ProtoKinetic-cargo = [color=#A46106]Кажется, этот протокинетик сжирает мощность ОППЭ втрое быстрее нормы. Похоже на кустарный разгон.[/color]
hidden-desc-ProtoKinetic-research = [color=#D381C9]Этот протокинетик при детальном осмотре кустарно модифицирован. На конденсатор подаётся куда большая мощность, а в казённик поступает не чистая аморфная плазма, а её смесь с титаном и вольфрамом. [/color]