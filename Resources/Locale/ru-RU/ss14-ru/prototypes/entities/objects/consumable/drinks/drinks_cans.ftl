...
ent-DrinkLemonLimeCan = баночка ХЫДЫЩЬ
    .desc = Вы хотели АПЕЛЬСИН. А он выдал вам лимон-лайм.
ent-DrinkLemonLimeCranberryCan = баночка клюквенного ХЫДЫЩЬ
    .desc = Вы хотите клюквенный ХЫДЫЩЬ? Любимый администраторами повсюду. Пейте в меру. Ограниченный тираж к праздникам!
