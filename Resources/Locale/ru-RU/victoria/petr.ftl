...
ent-PetrBaseUplinkRadio50TC = аплник Петрищевцев
    ...
    .desc =  Такой же, как у Синдиката, но с отдельным складом и товарами
ent-SpawnPointNukPetrCommander = спавн-точка командира Петрищевцев = Командир петрищевцев
...
ent-SpawnPointNukPetr = спавн-точка боевика Петрищевцев = Боевик петрищевцев
...
name-of-NukPetr = Боевик петрищевцев
...
name-of-NukPetrCommander = Командир петрищевцев
...
petr-briefing = Вместе со своими братьями уничтожьте всех прихвостней капитализма на станции!
petr-name-user = [color=#5e9cff]{ $name }[/color] ([color=gray]{ $username }[/color])

petr-reverse-stalemate = Петрищевцы, командный состав, учёные и СБ выжили. Случайность или договорнячок? Кто знает.
petr-won = Петрищевцы перебили всё СБ, учёных и командный состав. Пролетарии всех стран, соединяйтесь!
petr-lost = Петрищевцы были убиты, а их жертвы выжили. Рыночек порешал.
petr-stalemate = И петрищевцы, и капиталисты умерли.
petr-count =
    { $initialCount ->
        [one] Единственным революционером-петрищевцем был:
       *[other] Петрищевцев было { $initialCount }:
    }
