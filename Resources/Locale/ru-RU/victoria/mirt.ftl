...
ent-MirtBackpackRaz = миртанийский рюкзак скаута
    .suffix =  Миртан
    .desc =  Небольшой рюкзак, что является чудом инженерно мысли Империи Миртана. Имеет прикреплённый баллон для дыхания, встроенную радиостанцию, а изготовлен с использованием бс-кристаллов.
...
ent-MirtBootsRaz = миртанские сапоги разведчика
    .suffix =  Миртан
    .desc =  Крепкие, но очень лёгкие армейские сапоги. Из-за усовершенствованных материалов и систем амортизации позволяют носителям быстрей бегать и спрыгивать с большей высоты без травм.
ent-MirtHelmetGr = лёгкий шлем
    .suffix =  Миртан
    .desc =  Простой гражданский и тыловой шлем Империи Миртана. Слой стали и вера в Императора...
...
ent-MirtCloakSP = миртанийский плащ специалиста
    .suffix =  Миртан
    .desc =  Плащ, который носят специалисты Империи Миртана
...
ent-MirtCloakRaz = миртанийский плащ скаута
    .suffix =  Миртан
    .desc =  Удивительный плащ, который очень долго и кропотливо разрабатывался. Разведчики Империи Миртана относятся к этим плащам с большой любовью. В них было вложено множество отражающих и маскировочных технологий, систем покрытия против кислот и ядов. А ещё он банально тёплый и уютный, что особенно ценится, когда приходится днями прозябать в какой-то жуткой глуши.
ent-MirtHoodCloakRaz = капюшон плаща скаута
    .suffix =  Миртан
    .desc =  Закрывает половину головы. Но позволяет активировать маскировку.
ent-MirtArmorGr = лёгкий бронежилет
    .suffix =  Миртан
    .desc =  Лёгкий бронежилет, используемый ополченцами и гражданскими Империи Миртана, а так же военными штаба и тыла
...
ent-MirtHelmetHardsuitHig = шлем бронированного скафандра
    .suffix =  Миртан
    .desc =  Тяжёлый шлем, способоный защитить глаза и мозги верного служителя Миртана от (почти) всего.
ent-MirtHardsuitInk = инквизиторский боевой скафандр
    .suffix =  Миртан
    .desc =  Прочный боевой скафандр для сил инквизиции Империи Миртана.
ent-MirtHelmetHardsuitInk = шлем инквизиторского скафандра
    .suffix =  Миртан
    .desc =  Герметичный шлем, что защитит инквизитора от физических- смерти от когтей и зубов- и ментальных- чужих смертей- угроз.
ent-MirtMaskGas = дыхательная маска
    .suffix =  Миртан
    .desc =  Дыхательная маска разведчиков Империи Миртана. Достаточно плотно прилегает, сделана из крепкого материала, что защищает от мелких повреждений, а так же покрыта защитными слоями для повышения химической и биологической стабильности даже в условиях изменяющейся температуры.
...
ent-MirtShieldBig = большой миртанийский щит "Легионер"
    .suffix =  Миртан
    .desc =  Здоровый щит, что защищает верных войнов Императора от пуль, когтей и едких выделений.
...
ent-MirtBannerInk = знамя Империи Миртана
    ...
    .desc =  Знамя, изображающее Золотого орла - самого Императора Миртана, Бога в этой тёмной галактике, Спасителя и осветителя судьб, великого правителя! А так же карающий меч, что низвергает черепа предателей, еретиков и отступников к ногам Его!
ent-MirtBelt = миртанийский армейский пояс
    .suffix =  Миртан
    .desc =  Такие пояса используют военнослужащие Империи Миртана. Прочные и надёжные. Хорошо держат штаны на месте в бою.
...
ent-MirtMagazineGr = магазин к автомату "Вдова" (lhc)
    .suffix =  Миртан
    .desc = Скорей не магазин, а элемент охлаждения с небольшими зарядами для стрельбы.
...
ent-MirtRifle = блюспейс винтовка "Чаровница"
    .desc =  Блюспейс винтовка для лучших солдат Империи Миртана, что создана для быстрого устранения самых опасных противников. (lhc)
    .suffix =  Миртан
ent-MirtLaser = пожарный лазер "Месяц"
    .desc =  Крупный Лазер Империи Миртана созданный на основе Ноократских технологий, способный поджигать врагов лучом.
    .suffix =  Миртан
ent-MirtGran = гранатомёт "Медведка"
    .desc =  Гранатомёт армии Империи Миртана, запускающий крупные зажигательные снаряды.
    .suffix =  Миртан
...
ent-MirtNoocGanCold = ноократский автомат "Изморозь"
    .suffix =  Миртан
    .desc =  Лёгкий и дорогой автомат Ноократии Эранта, вызывающий у противника переохлаждение
ent-DoorElectronicsMirtAccess = плата доступа [Миртана]
    .suffix =  Миртан, Locked
    .desc =  Произведение искусства схемотехники, служащее определением достойных войти в шлюз.
...
ent-MirtMobHumanOffiInk = спавнер старшего миртанийского офицера
    .suffix =  GOST, Миртанийский
    .desc = Старший инквизитор Империи Миртана
