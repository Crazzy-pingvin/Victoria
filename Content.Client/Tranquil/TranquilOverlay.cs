...
public sealed class TranquilOverlay : Overlay
{
    ...
    public TranquilOverlay()
    {
        IoCManager.InjectDependencies(this);
        _tranquilShader = _prototypeManager.Index<ShaderPrototype>("Tranquil").InstanceUnique();
    }
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        if (!_entityManager.HasComponent<TranquilComponent>(playerEntity)
